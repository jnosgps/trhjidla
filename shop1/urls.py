...
urlpatterns = [
	...
	url(r'^producenti/(?P<kategorie>(fastfood|freshfood|sweets|raws|direct))/(?P<razeni>(az|top))/$', views.producers_list, name='producers_list'),
	url(r'^produkty/(?P<kategorie>(fastfood|freshfood|sweets|raws|direct))/(?P<razeni>(az|top))/$', views.products_list, name='products_list'),
